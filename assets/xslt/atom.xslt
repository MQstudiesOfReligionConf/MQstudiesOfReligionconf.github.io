...
<xsl:template match="/atom:feed">
	...
	<link rel="icon" sizes="32x32" href="http://www.studiesofreligionconf.com/assets/img/favicon.ico">

	<link rel="icon" sizes="192x192" href="http://www.studiesofreligionconf.com/assets/img/android-icon-192x192.png">

	<link rel="apple-touch-icon-precomposed" sizes="180x180" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-180x180.png">

	<link rel="apple-touch-icon-precomposed" sizes="152x152" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-152x152.png">

	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-144x144.png">

	<link rel="apple-touch-icon-precomposed" sizes="120x120" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-120x120.png">

	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-114x114.png">

	
	<link rel="apple-touch-icon-precomposed" sizes="76x76" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-76x76.png">

	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-72x72.png">

	<link rel="apple-touch-icon-precomposed" href="http://www.studiesofreligionconf.com/assets/img/apple-icon-precomposed.png">	

	<meta name="msapplication-TileImage" content="http://www.studiesofreligionconf.com/assets/img/ms-icon-144x144.png">
